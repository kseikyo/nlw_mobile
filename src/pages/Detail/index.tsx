...
import { StyleSheet, View, TouchableOpacity, Text, SafeAreaView, Image, Linking } from 'react-native'; 
...
const Detail = () => {
  ...
  function handleWhatsapp() {
    Linking.openURL(`whatsapp://send?phone=${point.whatsapp}&text=Olá, tenho interesse na coleta de resíduos`);
  }
